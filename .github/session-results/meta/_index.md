...
- **`_index.md` introduced** (session-0004) — AI-maintained living summary per story; read at session start for instant context; created on first save, updated on every subsequent save; never archived
...
| 0003 | session-0003-session-results-method-description.md | Updated method description: new terminology, opener concept, _index.md concept |
| 0004 | session-0004-enhancements-applied-generation.md | Executed opener: all renames, instructions update, session-0003 created; _index.md concept implemented and all three index files created |
