...
| 18 | XML documentation comments are written in **English** throughout the project — no split, no exceptions. (Reversed from session-0023 German decision; see session-0024.) |
