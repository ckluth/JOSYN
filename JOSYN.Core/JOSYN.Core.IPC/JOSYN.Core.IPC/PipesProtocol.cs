...
public class PipesProtocol: IPipesProtocol
{
    ...
    /// <inheritdoc/>
    public static Result<(string clientExePath, string sessionKey)> ParseServerCLIArguments(string[] args)
    {
    ...
    /// <inheritdoc/>
    public static string? ParseSessionKeyFromClientCLIArguments(string[] args)
    {
